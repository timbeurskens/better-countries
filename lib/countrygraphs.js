module.exports = {
  ...
  distanceListFrom: function(countryIndex, haystack){
    ...
    360 - Math.abs(haystack[countryIndex].east - element.west),360 - Math.abs(haystack[countryIndex].west - element.east), 360 - Math.abs(haystack[countryIndex].west - element.west), 360 - Math.abs(haystack[countryIndex].east - element.east));
    ...
    360 - Math.abs(haystack[countryIndex].north - element.south), 360 - Math.abs(haystack[countryIndex].south - element.north), 360 - Math.abs(haystack[countryIndex].north - element.north), 360 - Math.abs(haystack[countryIndex].south - element.south));
